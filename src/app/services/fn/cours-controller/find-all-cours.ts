...
export function findAllCours(http: HttpClient, rootUrl: string, params?: FindAllCours$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseCoursResponse>> {
